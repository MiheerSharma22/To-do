...
const CreateTodoModal = () => {
  ...
  function handleAddTodo(event) {
    if (event.key === "Enter") {
      ...
      const response = addTodo(createTodoRequest);
  ...
  return (
    ...
    createPortal(
      <div
        className="top-0 left-0 right-0 bottom-0 bg-[#00000088] absolute flex felx-col justify-center items-center min-w-[100%]  min-h-[100%] modal-dark-filter-bg"
